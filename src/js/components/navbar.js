        ...
        <div class="flex items-center justify-between h-20">
          ...
          <div class="hidden md:flex items-center gap-6">
            ...
            <div class="relative" id="lang-container">
              <button id="lang-btn" class="flex items-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors" title="Switch Language">
              ...
              <div id="lang-dropdown" class="hidden absolute right-0 top-full mt-3 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden z-50 min-w-[120px]">
                ...
                <button id="lang-opt-en" class="w-full px-4 py-2.5 text-sm text-left hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 font-medium transition-colors border-t border-gray-100 dark:border-gray-700">English EN</button>
              </div>
            </div>
